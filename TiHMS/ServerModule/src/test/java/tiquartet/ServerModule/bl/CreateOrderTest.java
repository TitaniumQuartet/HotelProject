...
public class CreateOrderTest{
	...
	public void testgetStrategy() throws RemoteException{
		...
		ResultMessage result3=createorder.preOrder(preorder1);
		assertEquals(result3.result,true);
		OrderStrategyVO orderstrategy1=createorder.getStrategy(preorder1.userID);
		...
		ResultMessage result4=createorder.confirm(orderInfo1);
		...
		assertEquals(list.get(0).orderId,orderInfo1.orderID);
