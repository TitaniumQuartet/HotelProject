...
public class StrategyDataSqlHelper implements StrategyDataHelper{
	...
	public List<StrategyPO> searchByHotel(int hotelID) {
		...
		String sql="select * from strategy where hotelId =" + hotelID ;
	...
	public ResultMessage update(StrategyPO strategy) {
	    ...
	    String sql = "update strategy set strategyIntro='" + strategy.getstrategyIntro() +
	    		...
	    		", circleId=" + strategy.getCircelID() +
	    		", startTime='" + strategy.getStartTime() +
	    		"', endTime='" + strategy.getEndTime() +
	    		"', memberDiscount='" + strategy.getMemberDiscountAsString() +
	    		"', memberThreshold='" + strategy.getMemberThresholdAsString() +
	    		"', strategyType=" + strategy.getStrategyType().ordinal() +
	    		", numOfRoom=" + strategy.getnumOfRoom() +
